/*
    ...
    Main QML file for the Feedback.
*/
...
Item {
    ...
    ColumnLayout {
        ...
        TextField {
            ...
            MouseArea {
                anchors.fill: parent
                onPressed: feedbackInput.forceActiveFocus()
            }

            EnterKeyAction.enabled: feedbackInput.text.length > 0 || feedbackInput.inputMethodComposing
